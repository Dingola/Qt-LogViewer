...
list(APPEND CMAKE_PREFIX_PATH ${INSTALLED_THIRD_PARTY_PATHS} "${SimpleQtLogger_INSTALL_ROOT}/${CMAKE_BUILD_TYPE}")
...
if(NOT ${MAIN_PROJECT_NAME}_INCLUDE_THIRD_LIBS_INTO_SOLUTION)
    ...
    if(SimpleQtLogger_FOUND)
        message(STATUS "[SimpleQtLogger] Found installed package. Skipping download/source inclusion.")
...
if(SHOULD_ADD_SOURCE)
    ...
    if(NOT EXISTS "${THIRD_PARTY_TARGET_DIR}/${THIRD_PARTY_TARGET}_src/CMakeLists.txt")
        message(STATUS "[SimpleQtLogger] Source not found (or forced refresh). Downloading...")
    else()
        message(STATUS "[SimpleQtLogger] Checking/Updating library...")
    endif()
...
if(${MAIN_PROJECT_NAME}_INCLUDE_THIRD_LIBS_INTO_SOLUTION)
    ...
    if(EXISTS "${THIRD_PARTY_TARGET_DIR}/${THIRD_PARTY_TARGET}_src/CMakeLists.txt")
        message(STATUS "[SimpleQtLogger] Adding source to solution (Enabled via ${MAIN_PROJECT_NAME}_INCLUDE_THIRD_LIBS_INTO_SOLUTION)...")
        ...
        message(FATAL_ERROR "[SimpleQtLogger] Source code missing even after download attempt.")
    endif()
    ...
    if(NOT PACKAGE_FOUND_INSTALLED)
        ...
        if(SimpleQtLogger_FOUND)
             message(STATUS "[SimpleQtLogger] Found package after build.")
        else()
             message(FATAL_ERROR "[SimpleQtLogger] Failed to find package even after build.")
        endif()
    endif()
endif()
