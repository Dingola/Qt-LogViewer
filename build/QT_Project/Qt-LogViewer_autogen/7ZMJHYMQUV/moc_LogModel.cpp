...
#include <memory>
#include "../../../../QT_Project/Headers/Qt-LogViewer/Models/LogModel.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_LogModel_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_LogModel_t qt_meta_stringdata_LogModel = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_LogModel[] = {
...
Q_CONSTINIT const QMetaObject LogModel::staticMetaObject = { {
    ...
    qt_meta_stringdata_LogModel.offsetsAndSizes,
    qt_meta_data_LogModel,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_LogModel_t,
        // Q_OBJECT / Q_GADGET
